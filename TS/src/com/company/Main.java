...
public class Main {
	...
	Tape tape = new Tape(new String[]{"#","#","#","1","0","0","#","1","0","#","#","#"});
	...
	Machine machine = new Machine(rules, tape, 3,10);
	machine.LetTheHeadDoHerThings();

	//System.out.println(machine.LetTheHeadDoHerThings());
    }
